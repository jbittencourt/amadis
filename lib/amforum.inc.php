...
class AMForum extends CMObj implements  CMACLAppInterface {
  ...
  public static function loadImageLibrary() {
  	...
  	$j->on("AMLibraryFiles::codeFile = AMFile::codeFile");
  ...
  public static function loadProjectImageLibrary() {
  	...
  	$q->setFilter('CMGroupMember::codeUser = '.$_SESSION['user']->codeUser.' AND CMGroupMember::status="'.CMGroupMember::ENUM_STATUS_ACTIVE.'" AND AMFile::codeFile != "NULL" AND AMFile::mimeType LIKE "image%"');
