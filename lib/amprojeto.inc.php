...
class AMProjeto extends CMObj {
  ...
  public function listAreas() {
    ...
    $q->setLimit(4,0);
    $q->setFilter("AMProjetoArea::codProjeto=".$this->codeProject);
  ...
  public function listDiaryPostsProject() {
    ...
    $q->setFilter("codeProjeto=$this->codeProject");
...
class AMProjetoArea extends CMObj {
...
class AMProjetoComentario extends CMObj {
  public function configure() {
