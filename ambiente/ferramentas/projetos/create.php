...
switch($_REQUEST[action]) {
 ...
 default:
   ...
   $form->setCancelUrl("$_CMAPP[services_url]/projetos/projects.php");

   if(is_a($_SESSION[cad_proj],CMObj)) {
 ...
 case "pag_1":
   ...
   if((!is_a($_SESSION[cad_proj],AMProjeto))||($_SESSION[cad_proj]->state==CMObj::STATE_NEW) || ($_REQUEST[frm_title]!=$_SESSION[cad_proj]->title)) {
     $proj = new AMProjeto;
   ...
   if(!is_a($_SESSION[cad_proj],AMProjeto)) {
