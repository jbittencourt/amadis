...
//formulary
$form = new CMWSmartForm(AMUser,"cad_user",$_SERVER[PHP_SELF]);
...
$form->forceCheckField(array("old_password","password","re_password"));
$form->submit_label = $_language[next];
$form->addOnSubmitAction("passwd_validate(this['frm_new_password'],this['frm_re_password'])");      
