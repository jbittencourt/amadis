...
//se nao houver codigo de curso, temos um problema
if (empty($_REQUEST[frm_codCurso])){
  
  $pag->addScript("window.alert('$_language[no_code]');location.href='../cursos/cursos.php'");
  echo $pag;
  die();
}
...
//define os links para as ferramentas q podem ser adicionadas ao curso. inclui tb a parte administrativa 
