...
abstract class AMChatTemplate extends CMHTMLObj {
  ...
  //essa funcao � um template e deve ser reimplementada para o chat de cada ambiente
  ...
  public function mainLoop($lastMessageTime="") {
    ...
    session_write_close();    //fecha a se��o para escrita evitando sess�es concorrentes, o que gera um bug no sistema
