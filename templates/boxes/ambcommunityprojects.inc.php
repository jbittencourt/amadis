...
class AMBCommunityProjects extends AMSimpleBox {
  ...
  public function __toString() {
	...
	parent::add("&nbsp;&nbsp;&nbsp;&raquo;");
	parent::add("<a href=\"$_CMAPP[services_url]/projetos/projeto.php?frm_codProjeto=$item->code\" class=\"cinza\">$item->title</a>");
	parent::add("<br>");
      }
      parent::add("<a href=\"".$_CMAPP[services_url]."/communities/projects.php?frm_codeCommunity=".$community->code."\" class=\"cinza\">&nbsp;&nbsp;$_language[more_projects]</a><br><br>");
    }
    else { 
